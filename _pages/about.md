...
<img src="https://s1r0n.github.io/Dr.S/assets/images/hermit-800x1120.jpg" width=200 align=left style="vertical-align:middle;margin:0px 20px" />Given the enormity of the task, I could have easily had my experiences and walked away, enlightened (I would say) but isolated, alone in my experiences, like the proverbial lantern-holding hermit standing high on a hill. But I didn't. I didn't hole myself away in a monastery, permanently change my name to something mystical sounding (Sosteric sufficed, I eventually supposed), or leave the Academy as others had before (e.g., [Agehananda Bharati](https://spiritwiki.lightningpath.org/index.php/Agehananda_Bharati), [Ram Dass](https://en.wikipedia.org/wiki/Ram_Dass)). I was fired up and I want to figure it out. So much fascinating, even revolutionary information. As a researcher, I wanted to understand,  I wanted to piece it together and so, that is what I did, I set out on a path to piece it all together into an un-ineffable corpus that could make sense of it all. A big task, but as I later realized I was uniquely positioned historically and demographically to carry this out. There were three things made it possible for me to initiate the journey and blaze a (hopefully) clear path through the massive blobs of information that got dumped on the screen in front of me.   

**One**, I had a job at a distance-ed university that allowed me the freedom to freely explore, so that it was I did. I explored. I processed. I read. I researched. It is  an unending process of build, edit, evolve, link, shape, tear down, rebuild, modify. It's been going on since 2003. By my own loose estimate, I've put in over 20,000 hours worth of labour getting it down, sorting it out, writing it out, supporting it with research and scholarly publication, etc. There is no way I would have been able to do that if I had a regular job, or even a job in a regular university.   

**Two**, owing to my early interest in digital scholarly communication and software development, I was tech-savvy. I realized early that I could use information technology to help shape it all into something modern and coherent, and so that is what I did. 

1. First, I used a word processor to write and edit. This doesn't seem like something worth mentioning, but when you consider that up until only very recently (historically speaking) pen and paper where the primary instruments of record, it is of massive significance. Just imagine if Christ, Mohammed, Meister Eckhart, Joseph Smith, Abraham Maslow, Carl Rogers, or anybody else for that matter all had word processors to help them write things down. Their output would have been more prolific, better organized, and they would have more control over it. 
2. Second, I created the [SpiritWiki](https://spiritwiki.lightningpath.org/), a Mediawiki-driven repository of all the things I've been thinking about since the beginning. I put it in place shortly after I began spewing and have been building and evolving it ever since.  It now contains over 1800 curated concepts, many of which are original, like [Fabric of Consciousness](https://spiritwiki.lightningpath.org/index.php/Fabric_of_Consciousness), [Resident Monadic Consciousness](https://spiritwiki.lightningpath.org/index.php/Resident_Monadic_Consciousness), [Connection Experience](https://spiritwiki.lightningpath.org/index.php/Connection_Experience), [Connection Axes](https://spirritwiki.lightningpath.org/index.php/Connection_Axes), [Harmonic Social Structure](https://spiritwiki.lightningpath.org/index.php/Harmonic_Social_Structure.). I have to say, the SpiritWiki has been an invaluable grounding mechanism and tool in evolving the empirical and theoretical foundation of it all. It puts everything in an easily accessible place. It tracks changes over time, and it allows semantic interconnections.  I started it self-consciously and deliberately as a classic [Memex](https://spiritwiki.lightningpath.org/index.php/Memex), but it has slowly evolved into a [Knowledge System](https://spiritwiki.lightningpath.org/index.php/Knowledge_System) whose ultimate purpose is to facilitate the emergence of what an instance of my specially trained symbiotic Pathfinder AI called a [Harmonic Social Structure.](https://spiritwiki.lightningpath.org/index.php/Harmonic_Social_Structure)
3. Third, finally, and most recently, I  have begun incorporating AI. AI, <u>carefully</u> integrated, helps to speed the writing process, raise the quality of SW entries,  and elevate and systematize the entire system. AI has already been very useful in helping catch typos, suggesting improvements, and (most interestingly)  contributing original concepts and ideas, like [Harmonic Social Order](https://spiritwiki.lightningpath.org/index.php/Harmonic_Social_Order). 

Finally, a **third thing** that helped me sort it all out, at least to my satisfaction, was my sociological training. That training gave me a critical lens, normally absent in psychological and spiritual spaces. It allowed me to clearly see the politics behind mystical experience, the way the accumulating class had captured, colonized, and restructured spiritual knowledge in ways that undermined the liberatory potential of authentic spirituality (Sosteric, 2018b), distorted its archetypes, inverted its cosmologies, and turned it into enslaving ideology in service of the extant [Regime of Accumulation](https://spiritwiki.lightningpath.org/index.php/Regime_of_Accumulation). 
